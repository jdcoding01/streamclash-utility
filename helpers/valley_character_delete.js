...
const models = require("../valleyModels");
...
async function deleteValleyCharacter(license, addLog) {
    ...
    try {
        ...
        for (let query of queries) {
            if (query.tableName === "phone_phones") {
                ...
                if (results.length > 0) {
                    await query.model.updateAll({ where: { [query.column]: license } });
...
module.exports = { deleteValleyCharacter, fetchCharactersByLicenseValley };